...
CREATE TABLE `disponibilidade` (
  ...
  `fk_idDia` int NOT NULL,
  `fk_idTurno` int NOT NULL,
  `fk_idBaba` int NOT NULL,
  PRIMARY KEY (`idDisponibilidade`),
  KEY `fk_idDia_idx` (`fk_idDia`),
  KEY `fk_idTurno_idx` (`fk_idTurno`),
  KEY `fk_idBaba` (`fk_idBaba`),
  CONSTRAINT `fk_idBaba` FOREIGN KEY (`fk_idBaba`) REFERENCES `baba` (`idBaba`),
  CONSTRAINT `fk_idDia` FOREIGN KEY (`fk_idDia`) REFERENCES `dia` (`idDia`),
  CONSTRAINT `fk_idTurno` FOREIGN KEY (`fk_idTurno`) REFERENCES `turno` (`idTurno`)
